...
fn main() {
    ...
    PlaneMapBuilder::new_fn(|point| perlin_surflet_2d(point, &hasher))
        .set_size(1024, 1024)
        .set_x_bounds(-5.0, 5.0)
        .set_y_bounds(-5.0, 5.0)
        .build()
        .write_to_file("perlin surflet 2d.png");
    PlaneMapBuilder::new_fn(|point| perlin_surflet_3d(point, &hasher))
        .set_size(1024, 1024)
        .set_x_bounds(-5.0, 5.0)
        .set_y_bounds(-5.0, 5.0)
        .build()
        .write_to_file("perlin surflet 3d.png");
    PlaneMapBuilder::new_fn(|point| perlin_surflet_4d(point, &hasher))
        .set_size(1024, 1024)
        .set_x_bounds(-5.0, 5.0)
        .set_y_bounds(-5.0, 5.0)
        .build()
